...
<title>Something Went Wrong — BLUERABBIT</title>
...
<section class="hero" style="padding:120px 0; text-align:center;">
  <div class="wrap" style="max-width:640px;">
    ...
    <h1 style="font-size:38px;">Something broke on our end.</h1>
    <p class="lede" style="margin:0 auto 34px;">Not you — us. We've logged it and we're on it. Try again in a moment.</p>
    <div class="cta-row" style="justify-content:center;">
      <a href="<?= site_url('/') ?>" class="btn btn-primary">Back to Home</a>
      <a href="<?= site_url('contact') ?>" class="btn btn-ghost">Report It</a>
    </div>
  </div>
</section>
