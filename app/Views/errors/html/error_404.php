...
<title>Page Not Found — BLUERABBIT</title>
...
<section class="hero" style="padding:120px 0; text-align:center;">
  <div class="wrap" style="max-width:640px;">
    ...
    <h1 style="font-size:38px;">This quest doesn't exist.</h1>
    <p class="lede" style="margin:0 auto 34px;">The page you're looking for was moved, renamed, or never unlocked. Let's get you back on the map.</p>
    <div class="cta-row" style="justify-content:center;">
      <a href="<?= site_url('/') ?>" class="btn btn-primary">Back to Home</a>
      <a href="<?= site_url('docs') ?>" class="btn btn-ghost">Browse Docs</a>
    </div>
  </div>
</section>
